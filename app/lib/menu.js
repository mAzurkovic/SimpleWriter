...
var template_win = [{
    ...
    submenu: [{
        ...
        click: function() {
            require('electron').shell.openExternal("https://github.com/mAzurkovic/SimpleWriter/releases/tag/" + app_version);
        }
    }, {
        ...
        label: 'View ' + app_name,
        click: function() {
            require('electron').shell.openExternal("http://kkkkk.ddddd.cccc");
        }
    }, {
        type: 'separator'
    }, {
